...
// $Id: SplashTimingAnalAlgos.cc,v 1.16 2010/04/26 12:57:31 dudero Exp $
//
//
...
#include "../interface/SplashTimingAnalAlgos.hh"
...
//
SplashTimingAnalAlgos::SplashTimingAnalAlgos(const edm::ParameterSet& iConfig,
...
}                    // SplashTimingAnalAlgos::SplashTimingAnalAlgos

//==================================================================

void
SplashTimingAnalAlgos::bookDetailHistos4cut(myAnalCut& cut)
{
...
}                     // SplashTimingAnalAlgos::bookDetailHistos4cut

//==================================================================

void
SplashTimingAnalAlgos::fillHistos4cut(myAnalCut& cut)
{
  HcalTimingAnalAlgos::fillHistos4cut(cut);
...
}                           // SplashTimingAnalAlgos::fillHistos4cut

//==================================================================

template<class Digi,class RecHit>
void SplashTimingAnalAlgos::processDigisAndRecHits
...
}                       // SplashTimingAnalAlgos::processDigisAndRecHits

//======================================================================

// ------------ method called to for each event  ------------
void
SplashTimingAnalAlgos::process(const myEventData& ed)
{
...
void
SplashTimingAnalAlgos::beginJob(const edm::EventSetup& iSetup,
