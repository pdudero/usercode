...
// 
/**\class BeamHitTimeCorrector BeamHitTimeCorrector.cc MyEDmodules/HcalTimingAnalAlgos/src/BeamHitTimeCorrector.cc
...
// $Id: BeamHitTimeCorrector.cc,v 1.6 2010/03/27 21:22:59 dudero Exp $
//
//
...
#include "../interface/BeamHitTimeCorrector.hh"
