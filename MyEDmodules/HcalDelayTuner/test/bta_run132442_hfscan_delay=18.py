...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("bta_run132442_hfscan_delay=18.root"),
    closeFileFast = cms.untracked.bool(False)
)
process.load("MyEDmodules.HcalDelayTuner.run132442files_cfi")
process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange('132442:218-132442:256')
...
process.p = cms.Path(process.hltLevel1GTSeed*process.hcalDigis*process.myreco*process.noscraping*process.oneGoodVertexFilter*process.allAnals)
