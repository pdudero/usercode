...
process.hbtimeanal.ampCutsInfC          = cms.bool(${AMPCUTSINFC})
process.hbtimeanal.minHit_GeVorfC       = cms.double(${HBHE_MINHIT_GEVORFC})
...
process.hetimeanal.ampCutsInfC          = cms.bool(${AMPCUTSINFC})
process.hetimeanal.minHit_GeVorfC       = cms.double(${HBHE_MINHIT_GEVORFC})
...
process.hftimeanal.ampCutsInfC          = cms.bool(${AMPCUTSINFC})
process.hftimeanal.minHit_GeVorfC       = cms.double(${HF_MINHIT_GEVORFC})
...
process.hotimeanal.ampCutsInfC          = cms.bool(${AMPCUTSINFC})
process.hotimeanal.minHit_GeVorfC       = cms.double(${HO_MINHIT_GEVORFC})
...
process.zdctimeanal.ampCutsInfC          = cms.bool(${AMPCUTSINFC})
process.zdctimeanal.minHit_GeVorfC       = cms.double(${ZDC_MINHIT_GEVORFC})
