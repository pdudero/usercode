...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("bta_run132476_hfscan_delay=14.root"),
    closeFileFast = cms.untracked.bool(False)
)
process.load("MyEDmodules.HcalDelayTuner.run132476files_cfi")
process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange('132476:58-132476:81')
