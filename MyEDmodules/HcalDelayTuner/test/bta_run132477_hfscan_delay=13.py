...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("bta_run132477_hfscan_delay=13.root"),
    closeFileFast = cms.untracked.bool(False)
)
process.load("MyEDmodules.HcalDelayTuner.run132477files_cfi")
process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange('132477:180-132477:224')
