...
process.TFileService = cms.Service("TFileService", 
    fileName = cms.string("bta_runs132993-5goodcoll_5050minus5ns.root"),
    closeFileFast = cms.untracked.bool(False)
)
process.load("MyEDmodules.HcalDelayTuner.runs132993-5goodcollfiles_cfi")
process.source.lumisToProcess = cms.untracked.VLuminosityBlockRange('132993:365-132993:384','132994:1-132994:131','132995:1-132995:19')
