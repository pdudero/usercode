...
hbherhfilt06ns.tfilterEnvelope     = cms.vdouble(0.0,3.0,
                                                1e99,3.0)
#hbherhfilt06ns.timeWindowCenterNs = cms.double(14.0)
...
horhfilt06ns.tfilterEnvelope       = cms.vdouble(0.0,3.0,
                                                 1e99,3.0)
#horhfilt06ns.timeWindowCenterNs   = cms.double(14.0)
...
hfrhfilt06ns.tfilterEnvelope       = cms.vdouble(0.0,3.0,
                                                 1e99,3.0)
#hfrhfilt06ns.timeWindowCenterNs   = cms.double(14.0)
...
hbherhfilt10ns.tfilterEnvelope     = cms.vdouble(0.0,5.0,
                                                1e99,5.0)
#hbherhfilt10ns.timeWindowCenterNs = cms.double(14.0)
...
horhfilt10ns.tfilterEnvelope       = cms.vdouble(0.0,5.0,
                                                 1e99,5.0)
#horhfilt10ns.timeWindowCenterNs   = cms.double(14.0)
...
hfrhfilt10ns.tfilterEnvelope       = cms.vdouble(0.0,5.0,
                                                 1e99,5.0)
#hfrhfilt10ns.timeWindowCenterNs   = cms.double(14.0)
...
hbherhfilt1ts.tfilterEnvelope     = cms.vdouble(0.0,12.5,
                                                1e99,12.5)
#hbherhfilt1ts.timeWindowCenterNs = cms.double(12.5)
...
horhfilt1ts.tfilterEnvelope       = cms.vdouble(0.0,12.5,
                                                 1e99,12.5)
#horhfilt1ts.timeWindowCenterNs   = cms.double(12.5)
...
hfrhfilt1ts.tfilterEnvelope       = cms.vdouble(0.0,12.5,
                                                 1e99,12.5)
#hfrhfilt1ts.timeWindowCenterNs   = cms.double(12.5)
...
hbherhfilt4ts.tfilterEnvelope     = cms.vdouble(0.0,50.0,
                                                1e99,50.0)
hbherhfilt4ts.timeWindowCenterNs = cms.double(50.0)
...
horhfilt4ts.tfilterEnvelope       = cms.vdouble(0.0,50.0,
                                                 1e99,50.0)
horhfilt4ts.timeWindowCenterNs   = cms.double(50.0)
...
hfrhfilt4ts.tfilterEnvelope       = cms.vdouble(0.0,50.0,
                                                 1e99,50.0)
hfrhfilt4ts.timeWindowCenterNs   = cms.double(50.0)
...
#hbherhfiltshp.timeWindowCenterNs = cms.double(14.0)
hbherhfiltshp.timeWindowGain      = cms.double(2.0)
hbherhfiltshp.tfilterEnvelope     = cms.vdouble(  4.00,6.25,  # was 6.02
#                                                  13.00,4.39,  # strange bump from TB04 data
                                                 23.50,4.41,
                                                 37.00,3.69,
                                                 56.00,3.15,
                                                 81.00,2.82,
...
#horhfiltshp.timeWindowCenterNs = cms.double(14.0)
horhfiltshp.timeWindowGain      = cms.double(2.0)
horhfiltshp.tfilterEnvelope     = cms.vdouble(  4.00,6.25,  # was 6.02
#                                                13.00,4.39,  # strange bump from TB04 data
                                               23.50,4.41,
                                               37.00,3.69,
                                               56.00,3.15,
