...
process.TFileService = cms.Service("TFileService",
     ...
     fileName = cms.string('hcaltimeanal-mutrig.root')
)
...
process.myanfilt6.hcalRecHitEscaleMaxGeV   = cms.double(150.5)
process.myanfilt10.hcalRecHitEscaleMaxGeV  = cms.double(150.5)
